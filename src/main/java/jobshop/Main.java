...
public class Main {
    ...
    static {
        ...
        solvers.put("SPT", new GreedySolver("SPT"));
        solvers.put("LRPT", new GreedySolver("LRPT"));
        solvers.put("EST_SPT", new GreedySolver("EST_SPT"));
        solvers.put("EST_LRPT", new GreedySolver("EST_LRPT"));
